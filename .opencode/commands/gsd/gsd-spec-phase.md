...
<execution_context>
@./.opencode/get-shit-done/workflows/spec-phase.md
...
**Flags:**
- `--auto` — Skip interactive questions; OpenCode selects recommended defaults and writes SPEC.md
...
<process>
Execute the spec-phase workflow from @./.opencode/get-shit-done/workflows/spec-phase.md end-to-end.
